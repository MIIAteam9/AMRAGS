...
// Define messages
        $messages = array();
        $initialPrompt = "Based on the given patient complaints and information, generate ICD-10 codes for all related symptoms. There is no need to generate anything other than ICD-10 codes. Use [{\"icd10\": \"A01\", \"symptom\": \"description \" },{\"icd10\": \"A02\", \"symptom\": \"description2\" },...] format, separated by commas between curly brackets, use English";
